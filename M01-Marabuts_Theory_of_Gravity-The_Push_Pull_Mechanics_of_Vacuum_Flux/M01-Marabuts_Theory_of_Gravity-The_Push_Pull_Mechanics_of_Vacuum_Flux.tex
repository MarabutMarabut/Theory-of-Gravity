...
\rhead{Marab\={u}t's Theory of Gravity: Manuscript 1 Version 44}
\cfoot{\thepage}

% -------------------------------------------------------------------------
% TITLE & AUTHOR
% -------------------------------------------------------------------------
\title{\textbf{Marab\={u}t's Theory of Gravity: \\The Push-Pull Mechanics of Vacuum Flux} \\[1em] \large{Establishing the Foundational Framework of the Electron Flow Model}}
...
\date{May 11, 2026 \\[1.5em] \small{DOI: \url{https://doi.org/10.5281/zenodo.20126552} | Manuscript 1 Version 44}}
...
\hypersetup{
  ...
  pdfkeywords={gravity, alternative to general relativity, beyond general relativity, post-Einsteinian gravity, hydrodynamic gravity, electron flow, micro-kinetic transfer, vacuum flux, fluid pressure gravity, solar proximity, thermal impedance, push-pull mechanics, black holes, dark matter, unified field theory, prime numbers, efm, electron flow model, evgs, electron void gravitational spheres, the unified fluid cosmos, mara class, m1, m2, m3, m4, m5, m6, m7, m8, m9, m10},
  pdfsubject={A hydrodynamic fluid pressure replacement for General Relativity based on vacuum electron flux.}
}
...
\begingroup
  ...
  Traditional gravitational mechanics rely on retroactive mass assignment to satisfy the kinematic observations of Johannes Kepler, the static orbital equations of Sir Isaac Newton, and the geometric space-time curvature of Albert Einstein \cite{kepler1609, newton1687, einstein1915}. This paper presents the Electron Flow Model (EFM), a generative, fluid-dynamic paradigm shift built upon a singular, foundational premise: \textbf{Gravity is pressure, not curvature, and not an intrinsic mass property.} 

  Because the vacuum of space is not empty---it is filled with a dense flux of electrons---a celestial body acts as a thermodynamic engine actively consuming that fluid. This creates a massive, physical pressure differential. Gravity is no longer a ``curve in empty space''; it is the literal mechanical drag and physical pressure of an ocean of electrons rushing past atomic matter to fill a negative void.
...
\section{Introduction}
  ...
  The Electron Flow Model (EFM) fundamentally rejects this geometric approach, establishing a new physical law: \textbf{Gravity is pressure, not curvature, and not an intrinsic mass property.} Because the vacuum of space is not an empty, frictionless void---it is filled with a dense flux of electrons---a celestial core acts as a thermodynamic engine actively consuming that fluid. This creates a massive, physical pressure differential. Gravity is no longer a ``curve in empty space''; it is the literal mechanical drag and physical pressure of an ocean of electrons rushing past atomic matter to fill a negative void.
...
\begin{tikzpicture}[scale=0.8]
  ...
  \node[red] at (6.5,1.2) {Newtonian Decline};
  \draw[thick, blue] (0.5,3.5) .. controls (1.5,3.2) and (3,3) .. (5.5,3);
  \node[blue] at (5.5,3.5) {EFM (Ambient Flux Pressure)};
\end{tikzpicture}
...
\begin{figure}[!ht]
  ...
  \makebox[\textwidth][c]{
    \begin{tikzpicture}[scale=1.8, >=Stealth]
      ...
      \draw[<-, blue!60, thin] (-1.658, 2.5) -- (-3.8, 2.5) node[anchor=east, font=\footnotesize\bfseries, align=right, purple] {Deep Space Boundary - Mara10 (M10)};
      
      % Space Layers (Perfectly horizontal, intersecting their respective spheres)
      \draw[<-, blue!50, thin] (-1.814, 2.0) -- (-3.8, 2.0) node[anchor=east, font=\footnotesize\bfseries, align=right, blue!80] {Vacuum Flux Interface - Mara9 (M9)};
      \draw[<-, blue!50, thin] (-1.873, 1.5) -- (-3.8, 1.5) node[anchor=east, font=\footnotesize\bfseries, align=right, blue!80] {Upper Intake Zone - Mara8 (M8)};
      \draw[<-, blue!50, thin] (-1.847, 1.0) -- (-3.8, 1.0) node[anchor=east, font=\footnotesize\bfseries, align=right, blue!80] {Mid-Orbit Cascade - Mara7 (M7)};
      \draw[<-, blue!50, thin] (-1.729, 0.5) -- (-3.8, 0.5) node[anchor=east, font=\footnotesize\bfseries, align=right, blue!80] {Approach Acceleration - Mara6 (M6)};
      
      % Surface Interface (Perfectly horizontal)
      \draw[<-, black, thick] (-1.5, 0) -- (-3.8, 0) node[anchor=east, font=\footnotesize\bfseries, align=right, black] {NASA Surface Datum - Mara5 (M5)};
      
      % Sub-Surface Layers (Reverted to angle down from the x-axis)
      \draw[<-, red!50, thin] (-1.2, 0) -- (-3.8, -0.5) node[anchor=east, font=\footnotesize\bfseries, align=right, red!80] {Internal Conduction - Mara4 (M4)};
      \draw[<-, red!50, thin] (-0.9, 0) -- (-3.8, -1.0) node[anchor=east, font=\footnotesize\bfseries, align=right, red!80] {Mid-Depth Zone - Mara3 (M3)};
      \draw[<-, red!50, thin] (-0.6, 0) -- (-3.8, -1.5) node[anchor=east, font=\footnotesize\bfseries, align=right, red!80] {Peak Flux Density - Mara2 (M2)};
      \draw[<-, red!50, thin] (-0.3, 0) -- (-3.8, -2.0) node[anchor=east, font=\footnotesize\bfseries, align=right, red!80] {Near-Core Compression - Mara1 (M1)};
      
      % Core Sink
      \draw[<-, red, thick] (0, 0) -- (-3.8, -2.5) node[anchor=east, font=\footnotesize\bfseries, align=right, red] {Core Negative Sink - Mara0 (M0)};
...
% -------------------------------------------------------------------------
\clearpage
% In Section 12.36 (Title and Intro Paragraph)
...
\subsection{Celestial Body 36: Comet 67P (The Porous Cometary Test)}
  ...
  \hspace*{1em} Calculated via the \textbf{Vacuum Flux Propagation} formula: $g_M = g_{M5} \cdot \left( \frac{R_{surf}}{R_M} \right)^2$
  \begin{itemize}
    \item \textbf{M10 Gravity:} $-0.000475 \left( \frac{1.70}{3.40} \right)^2 = \textbf{-0.000119}$ m/s$^2$
    \item \textbf{M9 Gravity:} $-0.000475 \left( \frac{1.70}{3.06} \right)^2 = \textbf{-0.000147}$ m/s$^2$
    \item \textbf{M8 Gravity:} $-0.000475 \left( \frac{1.70}{2.72} \right)^2 = \textbf{-0.000186}$ m/s$^2$
    \item \textbf{M7 Gravity:} $-0.000475 \left( \frac{1.70}{2.38} \right)^2 = \textbf{-0.000242}$ m/s$^2$
    \item \textbf{M6 Gravity:} $-0.000475 \left( \frac{1.70}{2.04} \right)^2 = \textbf{-0.000330}$ m/s$^2$
  \end{itemize}
  ...
  \hspace*{1em} Calculated via the dynamic \textbf{EFM Volumetric} formula: $g_M = (\alpha G) \cdot \rho_{M} \cdot R_M \cdot \tau_M \cdot \Omega_{shield}$
  \begin{itemize}
    \item \textbf{M4 Gravity:} $(2.792 \times 10^{-7}) \cdot 540 \cdot 1.36 \cdot 0.450 \cdot 1.000 = \textbf{0.000092}$ m/s$^2$
    \item \textbf{M3 Gravity:} $(2.792 \times 10^{-7}) \cdot 550 \cdot 1.02 \cdot 0.460 \cdot 1.000 = \textbf{0.000072}$ m/s$^2$
    \item \textbf{M2 Gravity:} $(2.792 \times 10^{-7}) \cdot 560 \cdot 0.68 \cdot 0.470 \cdot 1.000 = \textbf{0.000050}$ m/s$^2$
    \item \textbf{M1 Gravity:} $(2.792 \times 10^{-7}) \cdot 600 \cdot 0.34 \cdot 0.480 \cdot 1.000 = \textbf{0.000027}$ m/s$^2$
  \end{itemize}
...
\subsection{Celestial Body 38: TOI-1338 b (The Circumbinary Giant)}
  ...
  \begin{itemize}
    \item \textbf{Intake Force:} \\[0.5em]
    \hspace*{2em} $(\alpha G) \cdot \rho_{eff} \cdot R_{surf} \cdot \tau(T) = \text{Intake Force}$ m/s$^2$ \\[1em]
    \hspace*{2em} $(2.792 \times 10^{-7}) \cdot 800 \cdot 43640.0 \cdot 1.000 = 9.7473$ m/s$^2$
    
    \item \textbf{Centrifugal Offset:} \\[0.5em]
    \hspace*{2em} $\frac{v_{rot}^2}{R_{surf} \text{ (in meters)}} = \text{Centrifugal Offset}$ m/s$^2$ \\[1em]
    \hspace*{2em} $\frac{750^2}{43640000} \approx 0.0129$ m/s$^2$
    
    \item \textbf{M5 Gravity:} \\[0.5em]
    \hspace*{2em} $(\text{Intake Force} - \text{Centrifugal Offset}) \cdot \Omega_{shield} = g_{EFM} \text{ (Raw)}$ m/s$^2$ \\[1em]
    \hspace*{2em} $(9.7473 - 0.0129) \cdot 1.000 = \textbf{9.7344}$ m/s$^2$
  \end{itemize}
...
\begin{figure}[H] % Change [!ht] to [H]
  ...
  \begin{tikzpicture}[scale=0.9, >=Stealth]
    ...
    \node[font=\bfseries] at (0, -6.3) {Shared Axis ($R_{A} \rightarrow R_{B}$)};
...
\begin{landscape}
  % -------------------------------------------------------------------------
  % TABLE 1: Standard Solar System Celestial Bodies
  % -------------------------------------------------------------------------
  \begin{table}[H]
    \centering
    \caption{The Grand Compendium - Unified Triaxial Engine Matrix (Part 1: Standard Celestial Bodies)}
  ...
  \begin{table}[H]
    ...
    \resizebox{\linewidth}{!}{%
      ...
      \begin{tabular}{l c c c c c c c c c c c c c c c c c c c c c}
        ...
        \textbf{Sedna} & N/A & 497.5 & 497.5 & 497.5 & 2,000 & 0.150 & 9 & Pro & 0.01 & 0.01 & 0.02 & 0.02 & 0.03 & \textbf{0.04} & $\nexists$ & $\nexists$ & $\nexists$ & 0.04 & 0.03 & 0.02 & 0.01 \\
        \textbf{'Oumuamua}& N/A & 0.200 & 0.080 & 0.065 & 3,500 & 0.900 & 10 & Tum & 2e-4 & 2e-4 & 3e-4 & 4e-4 & 5e-4 & \textbf{-8e-4} & $\nexists$ & $\nexists$ & $\nexists$ & 8e-5 & 7e-5 & 5e-5 & 2e-5 \\
        \textbf{L 98-59 d}& N/A & 10,066.0 & 10,066.0 & 10,066.0 & 5,540 & 0.980 & 250 & Pro & 3.81 & 4.71 & 5.96 & 7.78 & 10.59 & \textbf{15.25} & $\nexists$ & $\nexists$ & $\nexists$ & 12.34 & 10.35 & 12.24 & 6.75 \\
        \textbf{Comet 67P} & N/A & 2.15 & 1.60 & 1.35 & 533 & 0.450 & 1 & Pro & 1e-4 & 1e-4 & 2e-4 & 2e-4 & 3e-4 & \textbf{-5e-4} & $\sim 10^{-4}$ & $\nexists$ & Exc & 9e-5 & 7e-5 & 5e-5 & 2e-5 \\
        \textbf{3I/ATLAS} & N/A & 2.50 & 2.50 & 2.50 & 400 & 0.800 & 2 & Pro & 3e-4 & 4e-4 & 5e-4 & 7e-4 & 1e-3 & \textbf{-1e-3} & $\nexists$ & $\nexists$ & $\nexists$ & 1.9e-4 & 1.5e-4 & 1.1e-4 & 6e-5 \\
        \textbf{TOI-1338 b}& N/A & 43,640.0 & 43,640.0 & 43,640.0 & 800 & 1.000 & 750 & Pro & 2.43 & 3.00 & 3.80 & 4.97 & 6.76 & \textbf{9.73} & $\nexists$ & $\nexists$ & $\nexists$ & 8.77 & 18.28 & 58.48 & 38.99 \\
        \textbf{EP250702a} & N/A & 15,000.0 & 15,000.0 & 15,000.0 & 250,000 & 1.000 & 0 & Pro & 261.75 & 323.15 & 408.98 & 534.18 & 727.08 & \textbf{1047.00} & $\nexists$ & $\nexists$ & $\nexists$ & 871.10 & 703.58 & 586.32 & 418.80 \\
        \textbf{NGC 1052-DF9}& N/A & 85,000.0 & 85,000.0 & 85,000.0 & 150 & 0.950 & 0 & Tum & 0.85 & 1.04 & 1.32 & 1.73 & 2.35 & \textbf{3.38} & $\nexists$ & $\nexists$ & $\nexists$ & 2.89 & 2.46 & 2.28 & 1.38 \\ 
        \textbf{Crab Pulsar} & N/A & 10.0 & 10.0 & 10.0 & $7.1\text{e}17$ & 1.000 & 1.88e6 & Pro & 4.07e11 & 5.03e11 & 6.36e11 & 8.31e11 & 1.13e12 & \textbf{1.63e12} & $\nexists$ & $\nexists$ & $\nexists$ & 1.61e12 & 1.24e12 & 8.93e11 & 5.03e11 \\
        \textbf{HD 189733 b} & N/A & 81,385.0 & 81,385.0 & 81,385.0 & 1,040 & 0.920 & 2000 & Pro & 5.42 & 6.69 & 8.47 & 11.07 & 15.06 & \textbf{21.69} & $\nexists$ & $\nexists$ & $\nexists$ & 18.39 & 37.63 & 125.42 & 83.61 \\
        \textbf{Arrokoth} & 44.00 & 8.9 & 8.9 & 8.9 & 250 & 0.400 & 1 & Tum & 8e-5 & 9e-5 & 1e-4 & 2e-4 & 2e-4 & \textbf{3e-4} & $\nexists$ & $\nexists$ & $\nexists$ & 2e-4 & 2e-4 & 1e-4 & 6e-5 \\
        \textbf{PSO J318.5} & N/A & 109,000.0 & 109,000.0 & 109,000.0 & 800 & 0.950 & 5000 & Pro & 5.73 & 7.07 & 8.95 & 11.69 & 15.91 & \textbf{22.91} & $\nexists$ & $\nexists$ & $\nexists$ & 20.81 & 43.36 & 138.87 & 92.58 \\
        \textbf{Sgr A*} & N/A & 12.0e6 & 12.0e6 & 12.0e6 & 150,000 & 1.000 & 0 & Pro & 1.25e5 & 1.55e5 & 1.96e5 & 2.56e5 & 3.49e5 & \textbf{5.02e5} & $\nexists$ & $\nexists$ & $\nexists$ & 4.28e5 & 3.61e5 & 3.35e5 & 2.34e5 \\
        \textbf{Cygnus X-1} & N/A & 44.0 & 44.0 & 44.0 & $3.5\text{e}16$ & 1.000 & 1.5e6 & Pro & 1.07e11 & 1.33e11 & 1.68e11 & 2.19e11 & 2.99e11 & \textbf{4.30e11} & $\nexists$ & $\nexists$ & $\nexists$ & 3.54e11 & 2.80e11 & 2.06e11 & 1.23e11 \\
        ...
        \textbf{Dimorphos} & 1.18 & 0.085 & 0.085 & 0.085 & 2,100 & 0.650 & 0.05 & Tum & 1e-6 & 1e-6 & 1e-6 & 2e-6 & 2e-6 & \textbf{3e-6} & $\nexists$ & $\nexists$ & $\nexists$ & 3e-5 & 2e-5 & 2e-5 & 1e-5 \\
        \textbf{Gliese 436 b} & N/A & 27,600.0 & 27,600.0 & 27,600.0 & 2,000 & 0.990 & 3000 & Pro & 3.73 & 4.61 & 5.83 & 7.62 & 10.37 & \textbf{14.93} & $\nexists$ & $\nexists$ & $\nexists$ & 13.43 & 11.44 & 12.33 & 9.25 \\
        \textbf{Planet Nine} & N/A & 19,000.0 & 19,000.0 & 19,000.0 & 1,500 & 0.970 & 1000 & Pro & 1.92 & 2.37 & 2.99 & 3.91 & 5.32 & \textbf{7.66} & $\nexists$ & $\nexists$ & $\nexists$ & 7.00 & 10.92 & 11.55 & 7.43 \\
        \textbf{TRAPPIST-1e} & N/A & 5,800.0 & 5,800.0 & 5,800.0 & 5,600 & 0.980 & 2 & Pro & 2.22 & 2.74 & 3.47 & 4.53 & 6.17 & \textbf{8.89} & $\nexists$ & $\nexists$ & $\nexists$ & 6.10 & 5.77 & 7.70 & 4.21 \\
        \textbf{PSR J1719} & N/A & 25,000.0 & 25,000.0 & 25,000.0 & 23,000 & 0.999 & 5000 & Pro & 39.84 & 49.19 & 62.26 & 81.32 & 110.68 & \textbf{159.38} & $\nexists$ & $\nexists$ & $\nexists$ & 133.88 & 104.70 & 72.59 & 39.09 \\
        \textbf{TON 618} & N/A & $1.95\text{e}11$ & $1.95\text{e}11$ & $1.95\text{e}11$ & 100,000 & 1.000 & 0 & Pro & 1.36e9 & 1.68e9 & 2.13e9 & 2.78e9 & 3.78e9 & \textbf{5.44e9} & $\nexists$ & $\nexists$ & $\nexists$ & 4.79e9 & 4.25e9 & 3.92e9 & 2.72e9 \\ 
        \textbf{TOI-5205 b} & 0.02 & 73,600.0 & 73,600.0 & 73,600.0 & 2,921 & 0.958 & 1000 & Pro & 6.26 & 7.73 & 9.78 & 12.77 & 17.39 & \textbf{25.03} & $\nexists$ & $\nexists$ & $\nexists$ & 17.18 & 26.05 & 63.15 & 39.00 \\
        \textbf{HATS-75 b} & 0.03 & 73,337.0 & 73,337.0 & 73,337.0 & 3,111 & 0.957 & 1100 & Pro & 7.23 & 8.93 & 11.30 & 14.76 & 20.08 & \textbf{28.92} & $\nexists$ & $\nexists$ & $\nexists$ & 26.12 & 31.11 & 68.54 & 44.25 \\
        \textbf{WASP-193b} & N/A & 107,000.0 & 107,000.0 & 107,000.0 & 59 & 0.910 & 5000 & Pro & 0.34 & 0.42 & 0.54 & 0.70 & 0.95 & \textbf{1.37} & $\nexists$ & $\nexists$ & $\nexists$ & 2.17 & 8.16 & 21.75 & 27.19 \\
        \textbf{LHS 3154 b} & 0.03 & 24,000.0 & 24,000.0 & 24,000.0 & 2,500 & 0.980 & 1500 & Pro & 1.84 & 2.27 & 2.87 & 3.75 & 5.10 & \textbf{7.35} & $\nexists$ & $\nexists$ & $\nexists$ & 8.27 & 10.75 & 17.91 & 12.06 \\
        \textbf{Superatom} & N/A & 1e-6 & 1e-6 & 1e-6 & 2,700 & 1.000 & 0 & Pro & 1.88e-10 & 2.33e-10 & 2.94e-10 & 3.85e-10 & 5.24e-10 & \textbf{7.54e-10} & $\nexists$ & $\nexists$ & $\nexists$ & 6.25e-10 & 4.86e-10 & 3.35e-10 & 1.73e-10 \\
        \textbf{TOI-201 c} & N/A & 70,777.0 & 70,777.0 & 70,777.0 & 18,148 & 1.000 & 12000 & Pro & 89.15 & 110.06 & 139.29 & 181.93 & 247.63 & \textbf{356.59} & $\nexists$ & $\nexists$ & $\nexists$ & 316.18 & 296.41 & 316.18 & 237.13 \\
        ...
        \textbf{Mrk 501 A} & N/A & 3.0e7 & 3.0e7 & 3.0e7 & 150,000 & 1.000 & 0 & Pro & 3.14e5 & 3.88e5 & 4.91e5 & 6.41e5 & 8.73e5 & \textbf{1.26e6} & $\nexists$ & $\nexists$ & $\nexists$ & 1.07e6 & 9.05e5 & 8.38e5 & 5.86e5 \\
        \textbf{Mrk 501 B} & N/A & 8.0e6 & 8.0e6 & 8.0e6 & 180,000 & 1.000 & 0 & Pro & 1.01e5 & 1.24e5 & 1.57e5 & 2.05e5 & 2.79e5 & \textbf{4.02e5} & $\nexists$ & $\nexists$ & $\nexists$ & 3.40e5 & 2.95e5 & 2.50e5 & 1.70e5 \\ \hline
      \end{tabular}%
    }
  \end{table}
\end{landscape}
...
\section{Conclusion: The Hydrodynamic Universe}
  ...
  For over three centuries, astrophysics has treated gravity as a static geometric property of mass. In traditional legacy physics (General Relativity), gravity is described as purely geometric, where matter simply ``rolls down the curve'' of spacetime. Marab\={u}t's Theory of Gravity dismantles this paradigm, offering a fully mechanistic, forward-calculating, fluid-dynamic alternative built upon one undeniable reality: \textbf{Gravity is pressure, not curvature, and not an intrinsic mass property.} Because the vacuum of space is not empty---it is filled with a dense flux of electrons and other sub-particles---a black hole or celestial core acts as a thermodynamic engine consuming that fluid. Gravity is the literal mechanical drag and physical pressure of an ocean of electrons rushing past atomic matter to fill a negative void.
...
\section*{The Pathway Forward}
  The push-pull mechanics of the Vacuum Flux established in this foundational text serve as the core hydrodynamic engine of gravity, effectively rendering the abstract geometric curvature of General Relativity obsolete. By proving that gravity operates as a tangible, fluid-dynamic pressure gradient, we have laid the absolute bedrock for the Electron Flow Model (EFM). As the manuscripts in ``Marab\={u}t's Theory of Gravity: The Unified Fluid Cosmos'' series unfold, these exact mechanics will be mathematically scaled to resolve the most persistent astrophysical anomalies---from the kinematic Sunyaev-Zeldovich effect to the final parsec problem. The geometric illusion of spacetime concludes here; the physical reality of the fluid cosmos has begun.
