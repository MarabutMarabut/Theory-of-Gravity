...
[![DOI: Framework Base](https://zenodo.org/badge/DOI/10.5281/zenodo.20126552.svg)](https://doi.org/10.5281/zenodo.20126552)
...
This repository serves as the computational foundation for **Manuscripts 1 through 15 of 30** in the comprehensive series, *Marabūt's Theory of Gravity*. The EFM is a generative, fluid-dynamic framework designed to fundamentally replace General Relativity and standard Quantum Mechanics, built on a single, undeniable foundational premise: **Gravity is Pressure, not curvature, and not an intrinsic mass property.**
...
* **Subatomic Acoustic Tethers:** Dismantling quantum "spooky action" by proving entanglement relies on superluminal ($v_L \gg c$) longitudinal acoustic shockwaves traveling through hyper-compressed fluid vortex cores.
...
## 📖 The Official Published Manuscripts

For full transparency, the complete LaTeX source codes and compiled PDFs are included in this repository.
...
[**Christopher Berry Marabūt**](https://orcid.org/0009-0001-9759-9587) | [![ORCID](https://info.orcid.org/wp-content/uploads/2019/11/orcid_16x16.png)](https://orcid.org/0009-0001-9759-9587) [0009-0001-9759-9587](https://orcid.org/0009-0001-9759-9587) | 📧 [chris.marabut@nestlink.com](mailto:chris.marabut@nestlink.com)
...
[**Angelina Lopez Marabūt**](https://orcid.org/0009-0007-9937-6145) | [![ORCID](https://info.orcid.org/wp-content/uploads/2019/11/orcid_16x16.png)](https://orcid.org/0009-0007-9937-6145) [0009-0007-9937-6145](https://orcid.org/0009-0007-9937-6145) | 📧 [angelina.marabut@nestlink.com](mailto:angelina.marabut@nestlink.com)
