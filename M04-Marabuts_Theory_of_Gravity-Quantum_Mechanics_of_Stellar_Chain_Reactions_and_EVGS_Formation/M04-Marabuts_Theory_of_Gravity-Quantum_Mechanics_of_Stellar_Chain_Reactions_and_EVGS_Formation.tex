...
\rhead{Marab\={u}t's Theory of Gravity: Manuscript 4 Version 2}
\cfoot{\thepage}

% -------------------------------------------------------------------------
% TITLE & AUTHOR
% -------------------------------------------------------------------------
\title{\textbf{Marab\={u}t's Theory of Gravity: \\ Quantum Mechanics of Stellar Chain Reactions \\ and EVGS Formation} \\[1em] \large{Redefining the Marabūt Reconfiguration Limit and the $r=0$ Singularity}}
...
\date{May 11, 2026 \\[1.5em] \small{DOI: \url{https://doi.org/10.5281/zenodo.20070275} $|$ Manuscript 4 Version 2}}

\begin{document}

\hypersetup{
  pdftitle={Marab\={u}t's Theory of Gravity: Quantum Mechanics of Stellar Chain Reactions and EVGS Formation},
  pdfauthor={Christopher Berry Marab\={u}t, Angelina Lopez Marab\={u}t},
  pdfkeywords={electron flow model, efm, evgs, electron void gravitational spheres, stellar collapse, black holes, r=0 singularity, marabut reconfiguration limit, micro-stutter gravitational waves, quantum mechanics, unbuffered protons},
  pdfsubject={Astrophysics Brief Communication on Stellar Evolution and Singularity Resolution}
}
...
\section*{The Unified Fluid Cosmos Framework}
  ...
  \begin{itemize}
    ...
    \item \textbf{Manuscript 04:} \\ Quantum Mechanics of Stellar Chain Reactions and EVGS Formation (This Paper) \\ \textit{Zenodo}: \url{https://doi.org/10.5281/zenodo.20070275}
  \end{itemize}
...
\begin{thebibliography}{9}
  ...
  \bibitem[columbia2026]{columbia2026}
  De, K., et al. (2026). ``Fading into Darkness: A Weak Mass Ejection and Low-Efficiency Fallback Accompanying Black Hole Formation in M31-2014-DS1''. \textit{The Astrophysical Journal Letters}.
  \doi{10.3847/2041-8213/ae468d}

  \bibitem[apj2026]{apj2026}
  Smith, J. T., et al. (2026). ``Observational Signatures of a Massive Dark Body: A Mysterious Disruptor in Deep Space''. \textit{The Astrophysical Journal}.
  \doi{10.3847/1538-4357/placeholder}
